...
1 - \Pi(x).
\end{align*}
Consequently we can also write the ordinal probabilities as
(@fig-ccdf-calcs)
\begin{align*}
p_{k}
&=
...
\Pi(-c_{k - 1}) - \Pi(-c_{k}).
\end{align*}
This equivalent form is more common in some references.
...
ordinal probabilities will also be arbitrarily _regardless of the shape
...
$$
gives what is known as an **ordered logit** model, or sometimes an
**ordered logistic** model.  The analytic form of the logistic
...
known as an **ordered probit** model.  The inverse normal cumulative
...
logit/logistic model.  Note that Stan's `ordered_logistic` model
...
```{.stan include="stan_programs/ordered_logistic_derived.stan" filename="ordered\\\_logistic\\\_derived.stan"}
```

```{r}
#| warning: false
#| message: false
fit <- stan(file="stan_programs/ordered_logistic_derived.stan",
            data=data, seed=8438338,
            warmup=1000, iter=2024, refresh=0)
```
...
```{.stan include="stan_programs/ordered_logistic.stan" filename="ordered\\\_logistic.stan"}
```

```{r}
#| warning: false
#| message: false
fit <- stan(file="stan_programs/ordered_logistic.stan",
            data=data, seed=8438338,
            warmup=1000, iter=2024, refresh=0)
```
...
```{.stan include="stan_programs/ordered_logistic_induced.stan" filename="ordered\\\_logistic\\\_induced.stan"}
```
...
In fact comparing to the `ordered_logistic_derived` model the inferences
for the interior cut points are identical.
...
`ordered_logistic_derived` models is that they employed a more
...
```{.stan include="stan_programs/ordered_logistic_comp_uniform.stan" filename="ordered\\\_logistic\\\_comp_uniform.stan"}
```
...
#| message: false
#| cache: true
fit <- stan(file="stan_programs/ordered_logistic_comp_uniform.stan",
            data=data, seed=8438338,
            warmup=1000, iter=2024, refresh=0)
```
...
```{.stan include="stan_programs/ordered_logistic_comp_anchor.stan" filename="ordered\\\_logistic\\\_comp\\\_anchor.stan"}
```

```{r}
#| warning: false
#| message: false
fit <- stan(file="stan_programs/ordered_logistic_comp_anchor.stan",
            data=data, seed=8438338,
            warmup=1000, iter=2024, refresh=0)
```
...
```{.stan include="stan_programs/ordered_logistic_comp_induced.stan" filename="ordered\\\_logistic\\\_comp\\\_induced.stan"}
```

```{r}
#| warning: false
#| message: false
fit <- stan(file="stan_programs/ordered_logistic_comp_induced.stan",
            data=data, seed=8438338,
            warmup=1000, iter=2024, refresh=0)
```
...
```{.stan include="stan_programs/ordered_logistic_comp_derived.stan" filename="ordered\\\_logistic\\\_comp\\\_derived.stan"}
```

```{r}
#| warning: false
#| message: false
fit <- stan(file="stan_programs/ordered_logistic_comp_derived.stan",
            data=data, seed=8438338,
            warmup=1000, iter=2024, refresh=0)
```
...
```{.stan include="stan_programs/ordered_logistic_comp_induced_hier.stan" filename="ordered\\\_logistic\\\_comp\\\_induced\\\_hier.stan"}
```

```{r}
#| warning: false
#| message: false
fit <- stan(file="stan_programs/ordered_logistic_comp_induced_hier.stan",
            data=data, seed=8438338,
            warmup=1000, iter=2024, refresh=0)
```
...
```{.stan include="stan_programs/ordered_logistic_comp_derived_hier.stan" filename="ordered\\\_logistic\\\_comp\\\_derived\\\_hier.stan"}
```

```{r}
#| warning: false
#| message: false
fit <- stan(file="stan_programs/ordered_logistic_comp_derived_hier.stan",
            data=data, seed=8438338,
            warmup=1000, iter=2024, refresh=0)
```
...
ordering when we modeling how ordinal probabilities vary around that
