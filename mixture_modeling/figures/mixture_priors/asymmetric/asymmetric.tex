  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \begin{scope}
      ...
      \draw[domain=-3:3, smooth, samples=100, variable=\x, custom, line width=1] 
        plot (\x, { 4.5 * ( 0.333 * normal(\x, -0.75, 0.25) ) - 2});
        
      \pgfmathsetmacro{\prop}{50};
      \colorlet{custom}{dark!\prop!white};
      \draw[domain=-3:3, smooth, samples=100, variable=\x, custom, line width=1] 
        plot (\x, { 4.5 * ( 0.333 * normal(\x, -0.5, 0.45) ) - 2});

      \pgfmathsetmacro{\prop}{75};
      \colorlet{custom}{dark!\prop!white};
      \draw[domain=-3:3, smooth, samples=100, variable=\x, custom, line width=1] 
        plot (\x, { 4.5 * ( 0.333 * normal(\x, +0.25, 0.75) ) - 2});
       
      \draw[domain=-3:3, smooth, samples=100, variable=\x, dark, line width=1] 
       plot (\x, { 4.5 * ( 0.333 * normal(\x, -0.75, 0.25) + 0.333 * normal(\x, -0.5, 0.45) + 0.333 * normal(\x, +0.25, 0.75) ) - 2}); 
    \end{scope}
